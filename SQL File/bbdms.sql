...
(6, 'ALi', '7797987981', 'ali@gmail.com', 'Male', 35, 'O-', 'H-900, Ravinderpuri colony,', ' Call me if blood require', '2024-01-02 12:43:41', 1, '202cb962ac59075b964b07152d234b70'),
(9, 'James', '9789797979', 'jm@gmail.com', 'Male', 56, 'A+', 'Haiderbad', ' gjhgjhgjhghjghj', '2024-01-03 06:09:08', 1, '202cb962ac59075b964b07152d234b70'),
(10, 'Gufran Doe', '1236547890', 'gfd@gmail.com', 'Male', 25, 'O-', 'A 5623 XYZ Street New Lahore', ' NA', '2024-01-03 01:50:58', 1, 'f925916e2754e5e03f75dd58a5733251'),
(11, 'Muneeb ur Rehman', '1231231230', 'test@gmail.com', 'Male', 26, 'AB+', 'ABc Street Sector 20 Sialkot', ' NA', '2024-01-04 01:22:52', 1, 'f925916e2754e5e03f75dd58a5733251'),
(12, 'Ali Haider', '1425362514', 'ak@test.com', 'Male', 30, 'A-', 'NA', ' NA', '2024-01-05 17:31:08', 1, 'f925916e2754e5e03f75dd58a5733251');
-- --------------------------------------------------------
...
(2, 3, 'Ahmad', 'ahm@gmail.com', 5896231478, 'Others', 'Please help', '2024-01-06 11:58:48'),
(3, 6, 'Alisha', 'ash@gmail.com', 1236547896, 'Brother', 'do the needful', '2024-01-07 12:02:12'),
(4, 10, 'Gufran Paplo', 'gfp@gmail.com', 2536251425, 'Mother', 'Please help me', '2024-01-08 01:51:52'),
(5, 11, 'Muneeb Ranja', 'mbr@gmail.com', 8525232102, 'Others', 'Need blood on urgent basis', '2024-01-08 01:24:18');
...
BEGIN
    ...
    -- Use your actual path to the mysqldump command
    SET @command = CONCAT('mysqldump -u your_username -pYourPassword your_database > ', @backup_path, @backup_name);
...
DELIMITER //
CREATE TRIGGER `tr_update_bloodgroup_postingdate` AFTER INSERT ON `tblblooddonars`
FOR EACH ROW
BEGIN
    UPDATE `tblbloodgroup` SET `PostingDate` = current_timestamp() WHERE `BloodGroup` = NEW.`BloodGroup`;
END //
DELIMITER ;

CREATE VIEW `vw_active_blooddonors` AS
SELECT *
FROM `tblblooddonars`;
